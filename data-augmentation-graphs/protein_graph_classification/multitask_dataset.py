...
class MultitaskBatchSampler(BatchSampler):
    ...
    def _get_shuffled_index_batches(dataset_len, batch_size):
        index_batches = [
            ...
            for i in range(0, dataset_len-batch_size, batch_size) # remove the last incomplete batch
        ]
    ...
    def __iter__(self):
        ...
        all_indices = self.gen_task_indices(self._train_data_list)
    ...
    @staticmethod
    def gen_task_indices(train_data_list, mix_opt = 0.5, extra_task_ratio = 0):
        '''
