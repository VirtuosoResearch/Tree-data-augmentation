...
class GNN(torch.nn.Module):
    ...
    """
    def __init__(self, num_layer, emb_dim, num_node_type, JK = "last", drop_ratio = 0, gnn_type = "gin"):
...
class GNN_graphpred(torch.nn.Module):
    ...
    """
    def __init__(self, num_layer, emb_dim, num_node_type, num_tasks, JK = "last", drop_ratio = 0, graph_pooling = "mean", gnn_type = "gin"):
        ...
        self.gnn = GNN(num_layer, emb_dim, num_node_type, JK, drop_ratio, gnn_type = gnn_type)
    ...
    def forward_predict(self, graph_representation):
